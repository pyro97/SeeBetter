...
<div class="login">
	...
	<form name="formLogin"action="admins?action=modifica" method="POST" >

  <ul class="griglia">
   <li>
   <h2>Modifica un prodotto</h2>
   <a href="Admin.jsp">Admin Page</a></br></br>
   <label for="codmod"><b>Inserisci codice Prodotto da modificare</b></label> 
    <input type="text" placeholder="GDSFDS1341" name="codmod" ></br>
    <h2 class="compila"> Compila i campi che desideri  modificare</h2>
  ...
  <label for="mar"><b>Marca</b></label> 
    ...
    <button id="log" type="submit" >Modifica</button>
    </li>
    </ul>
    </form>
</div>
